	...
	<section class="sep-bot top-smspace">
		<div class="container clearfix bot-space">
			<div class="label label-info show text-18 clearfix no-round ver-mspace">
				<div class="span smspace"><?php echo sprintf(__l('Profile Image - %s'), $this->request->data['User']['username']); ?></div>
...
?>
 ...
 <div class="offset1 input radio pull-left user-profile-image" >
            <?php
				$before_span = '<span><span class="avtar-box pr left-mspace">';
