...
<div class="settings form">
  ...
  <div class="form-actions">
    <?php echo $this->Form->submit(__l('Ok'),array('class'=>'btn btn-primary'));?>
    <?php echo $this->Html->link(__l('Cancel'), array('controller' => 'settings' , 'action' => 'index'),array('class'=>'btn btn-warning'));?>
  </div>
