...
<?php echo $this->Form->create('AffiliateRequest', array('class' => 'form-horizontal normal requestform'));?>
	...
	<?php
        ...
        $options = array(ConstAffiliateRequests::Pending => __l('Waiting for Approval'), ConstAffiliateRequests::Accepted => __l('Approved'), ConstAffiliateRequests::Rejected => __l('Disapproved'));        
	?>
 ...
 <div class="clearfix bot-mspace"><label class='pull-left'><?php echo __l('Approved?');?></label>
  ...
  ?></div>
	...
	<div class="submit-block clearfix top-space top-mspace">
