<div class="sep-bot bot-mspace">
  <h2 class="container textb text-32 bot-space mob-dc"><?php echo $this->pageTitle; ?></h2>
</div>
...
<div class="row space thumbnail">
  ...
  <div class="row page-header">
    ...
    <div class="span"><span class="label span4 share-follow <?php echo ($this->request->params['named']['type'] == 'gmail')? 'label-info' : ''; ?>"><?php echo __l('Gmail'); ?></span></div>
    <div class="span"><span class="label span4 share-follow <?php echo ($this->request->params['named']['type'] == 'yahoo')? 'label-info' : ''; ?>"><?php echo __l('Yahoo!'); ?></span></div>
  </div>
  </div>
  ...
  <div class="form-actions">
    <?php
      if ($this->request->params['named']['type'] == 'yahoo') {
        ...
        echo $this->Html->link(__l('Skip') . ' >>', array('controller' => 'social_marketings', 'action' => 'import_friends',  'type' => $next_action), array('title' => 'Skip', 'class' => 'blackc pull-right js-tooltip mspace'));
      }
    ?>
  </div>
</div>
