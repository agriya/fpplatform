<div class="messages form">
	...
	<?php echo $this->element('admin_sidebar', array('cache' => array('time' => Configure::read('messages.listing_element_cache_duration'))));?>
<?php
...
?>
<?php
echo $this->Form->create('Message', array('action' => 'compose', 'class' => 'normal form-horizontal ', 'enctype' => 'multipart/form-data'));
?>
		<fieldset>
