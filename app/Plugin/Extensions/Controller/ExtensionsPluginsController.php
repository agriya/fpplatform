...
class ExtensionsPluginsController extends AppController
{
    ...
    public function admin_index()
    {
        ...
        $image_title_icons = array(
            ...
            'Plugins For Job Module' => 'job-module-icon',
            'Plugins For Request Module' => 'request-module-icon',
        );
		$modules = array(
			'Jobs',
            'Requests'
        ...
        $title_description = array(
            ...
            'Plugins For Pledge Module' => __l('Plugins that are specific to pledge module is listed here.') ,
            'Plugins For Equity Module' => __l('Plugins that are specific to equity module is listed here.') ,
    ...
    public function admin_toggle($plugin = null)
    {
        ...
        $paymentGateways = array(
            'Wallets' => ConstPaymentGateways::Wallet,
