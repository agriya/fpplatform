<div class="space">
    <div class="pull-right hor-space">
      <?php echo $this->Html->link('<i class="icon-plus-sign"></i> '.__l('Add Theme'), array('action' => 'add'), array('class' => 'blackc', 'title' =>  __l('Add'), 'escape' => false)); ?>
    </div>
    <div class="clearfix">
   ...
   <div class="thumbnail">
    ...
    <?php
            ...
            echo $this->Html->tag('div', $this->Html->link('<i class="icon-ok"></i> ' . __l('Activate'), array('action' => 'activate', $themeAlias), array('class' => 'js-confirm', 'escape' => false, 'title' => __l('Activate'))) . $this->Html->link(' <i class="icon-remove"></i> ' . __l('Delete'), array('action' => 'delete', $themeAlias), array('class' => 'js-confirm', 'escape' => false, 'title' => __l('Delete'))));
          echo '</li>';
        }
      }
      if (empty($is_themes_available)) {
        echo '<li class="errorc"> ' . sprintf(__l('No %s available'), __l('Themes')) . '</li>';
      }
    ?>
    </ol>
    </div>
