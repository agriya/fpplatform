...
'
        ...
        array(
            ...
            'description' => 'Order status has been changed to in progress overtime since it didn\'t delivered on time.
Buyer now has option to cancel the order.'
        ) ,
        array(
            'id' => '10',
            'created' => '0000-00-00 00:00:00',
            ...
            'description' => 'Order was cancelled by the ##BUYER## during overtime status.
Buyer amount has been refunded.'
        ) ,
        array(
            'id' => '11',
            'created' => '0000-00-00 00:00:00',
            ...
            'description' => 'Order was cancelled by Site Administrator. 
Buyer amount has been refunded'
        ) ,
        array(
            'id' => '12',
            ...
            'description' => 'Order was closed automatically by Site Administrator since buyer was not able to give review for the order in time.
