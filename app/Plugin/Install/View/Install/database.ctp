<div class="install form">
	...
	<iframe frameborder="0" width="630px" height="80px" src="http://installer.dev.agriya.com/info5.html"></iframe>
			...
			echo $this->Form->create('Install', array('url' => array('controller' => 'install', 'action' => 'database'), 'class' => 'form-horizontal normal')); ?>
	<div class="content-block round-4">
	  ...
	  <?php 
			...
			echo $this->Form->input('Install.database', array('label' => 'Name', 'default' => 'fpplatform'));
