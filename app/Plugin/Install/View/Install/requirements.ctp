<div class="install index">
	...
	<?php $required = '';?>
	<table border="2" class="table list table-striped table-hover sep">
		<tr>
		...
		<?php
			...
			$class = 'class="red"';
			// has error accept 5.2.6 need to change
			if (5 == $php_version[0] && (($php_version[1]==2 && $php_version[2] >= 7) || ($php_version[1]==3) || ($php_version[1]==4 && $php_version[2] <=12))){
				$class = 'class="green"';
			} else {
