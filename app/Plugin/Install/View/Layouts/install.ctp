...
<head>
  ...
  <title><?php echo $title_for_layout; ?> - <?php echo __l('FPPlatform'); ?></title>
  ...
  <div class="container_24">
    <div class="header">
      <div class="h-left">
        <div class="h-right">
          <div class="h-center">
            <h1 class="grid_left"><a href="#" title="FPPlatform">FPPlatform</a></h1>
    ...
    <div class="main clearfix">
      <div class="side-content grid_7">
        ...
        <ol class="list round-4 grid_6">
          ...
          <li class="round-4<?php if ($this->request->params['action'] == 'configuration') { ?> active<?php } ?>">6. FPPlatform Configuration</li>
    ...
    <div class="footer">
      <div class="footer-inner clearfix">
        <p>&copy;<?php echo date('Y'); ?> <a title="FPPlatform" href="http://fpplatform.dev.agriya.com/">FPPlatform</a>. All rights reserved.</p>
        <p class="powered clearfix"><span><a class="powered" target="_blank" title="Powered by FPPlatform" href="http://fpplatform.dev.agriya.com/">Powered by FPPlatform</a>,</span>
