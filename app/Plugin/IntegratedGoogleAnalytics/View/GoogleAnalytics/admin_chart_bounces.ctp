...
?>
  ...
  <div class="offset2 top-space span6 clearfix mob-clr">
	...
	<dl class="list list-mid no-mar">
		<dt class="pr hor-mspace grayc text-13"><?php echo __l('Page Views'); ?></dt>
		<dd class="textb text-30 no-mar graydarkerc hor-space pr" title="<?php echo $total_pageviews; ?>"><?php echo $total_pageviews; ?></dd>
	</dl>
  </div>
  <div class="offset2 top-space span6 clearfix mob-clr">
	<div class="pull-left show">
	...
	<dl class="list list-mid no-mar">
		<dt class="pr hor-mspace grayc text-13"><?php echo __l('Visitors'); ?></dt>
		<dd class="textb text-30 no-mar graydarkerc hor-space pr" title="<?php echo $total_visitors; ?>"><?php echo $total_visitors; ?></dd>
	</dl>
 </div>
  ...
  <div class="offset2 top-space span6 clearfix mob-clr">
	...
	<dl class="list list-mid no-mar">
		<dt class="pr hor-mspace grayc text-13"><?php echo __l('Bounces'); ?></dt>
		<dd class="textb text-30 no-mar graydarkerc hor-space pr" title="<?php echo $total_bounces; ?>"><?php echo $total_bounces; ?></dd>
	</dl>
  </div>
<?php } }?>