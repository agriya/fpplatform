<div class="js-ecommerce js-cache-load-admin-ecommerce_chart">
  <div class="accordion-group">
    <div class="accordion-heading bootstro" data-bootstro-step="2" data-bootstro-content="<?php echo __l(" Ecommerce represents the total transactions made in the selected period and transaction revenue for the site. It shows the pie chart representation for revenue gather by which source and pie chart representation for revenue gather by job.");?>" data-bootstro-width="600px" data-bootstro-title="Ecommerce">
