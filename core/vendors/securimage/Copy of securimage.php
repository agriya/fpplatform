...
class Securimage {
  ...
  var $session_var = 'securimage_code_value';
  ...
  function saveData()
  {
    $_SESSION[$this->session_var] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION[$this->session_var]) && !empty($_SESSION[$this->session_var]) ) {
      if ( $_SESSION[$this->session_var] == strtolower(trim($this->code_entered)) ) {
